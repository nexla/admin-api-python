...
class AuditLog(Base):
    ...
    @classmethod
    def export_batch(cls, batch_size: int = None) -> Tuple[List['AuditLog'], str]:
    ...
    def __repr__(self) -> str:
        return f"<AuditLog(id={self.id}, action='{self.action.value}', auditable_type='{self.auditable_type}', auditable_id={self.auditable_id})>"
