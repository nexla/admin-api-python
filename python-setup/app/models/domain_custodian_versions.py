"""
DomainCustodianVersions model - Generated from domain_custodian_versions table
"""
...
class DomainCustodianVersions(Base):
    __tablename__ = "domain_custodian_versions"
    ...
    def __repr__(self):
        return f"<DomainCustodianVersions({self.id if hasattr(self, 'id') else 'no-id'})"
