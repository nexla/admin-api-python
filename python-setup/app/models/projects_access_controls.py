"""
ProjectsAccessControls model - Generated from projects_access_controls table
"""
...
class ProjectsAccessControls(Base):
    __tablename__ = "projects_access_controls"
    ...
    def __repr__(self):
        return f"<ProjectsAccessControls({self.id if hasattr(self, 'id') else 'no-id'})"
