"""
DataSinkVersions model - Generated from data_sink_versions table
"""
...
class DataSinkVersions(Base):
    __tablename__ = "data_sink_versions"
    ...
    def __repr__(self):
        return f"<DataSinkVersions({self.id if hasattr(self, 'id') else 'no-id'})"
