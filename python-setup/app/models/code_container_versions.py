"""
CodeContainerVersions model - Generated from code_container_versions table
"""
...
class CodeContainerVersions(Base):
    __tablename__ = "code_container_versions"
    ...
    def __repr__(self):
        return f"<CodeContainerVersions({self.id if hasattr(self, 'id') else 'no-id'})"
