"""
FlowTriggerVersions model - Generated from flow_trigger_versions table
"""
...
class FlowTriggerVersions(Base):
    __tablename__ = "flow_trigger_versions"
    ...
    def __repr__(self):
        return f"<FlowTriggerVersions({self.id if hasattr(self, 'id') else 'no-id'})"
