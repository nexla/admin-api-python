"""
OrgsAccessControlVersions model - Generated from orgs_access_control_versions table
"""
...
class OrgsAccessControlVersions(Base):
    __tablename__ = "orgs_access_control_versions"
    ...
    def __repr__(self):
        return f"<OrgsAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
