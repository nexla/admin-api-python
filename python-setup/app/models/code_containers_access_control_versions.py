"""
CodeContainersAccessControlVersions model - Generated from code_containers_access_control_versions table
"""
...
class CodeContainersAccessControlVersions(Base):
    __tablename__ = "code_containers_access_control_versions"
    ...
    def __repr__(self):
        return f"<CodeContainersAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
