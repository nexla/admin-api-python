"""
TeamsAccessControlVersions model - Generated from teams_access_control_versions table
"""
...
class TeamsAccessControlVersions(Base):
    __tablename__ = "teams_access_control_versions"
    ...
    def __repr__(self):
        return f"<TeamsAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
