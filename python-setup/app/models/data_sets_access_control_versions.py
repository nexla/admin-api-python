"""
DataSetsAccessControlVersions model - Generated from data_sets_access_control_versions table
"""
...
class DataSetsAccessControlVersions(Base):
    __tablename__ = "data_sets_access_control_versions"
    ...
    def __repr__(self):
        return f"<DataSetsAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
