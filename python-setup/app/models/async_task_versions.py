"""
AsyncTaskVersions model - Generated from async_task_versions table
"""
...
class AsyncTaskVersions(Base):
    __tablename__ = "async_task_versions"
    ...
    def __repr__(self):
        return f"<AsyncTaskVersions({self.id if hasattr(self, 'id') else 'no-id'})"
