"""
MarketplaceItems model - Generated from marketplace_items table
"""
...
class MarketplaceItems(Base):
    ...
    def __repr__(self):
        return f"<MarketplaceItems({self.id if hasattr(self, 'id') else 'no-id'})"
