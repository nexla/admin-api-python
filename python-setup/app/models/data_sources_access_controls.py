"""
DataSourcesAccessControls model - Generated from data_sources_access_controls table
"""
...
class DataSourcesAccessControls(Base):
    __tablename__ = "data_sources_access_controls"
    ...
    def __repr__(self):
        return f"<DataSourcesAccessControls({self.id if hasattr(self, 'id') else 'no-id'})"
