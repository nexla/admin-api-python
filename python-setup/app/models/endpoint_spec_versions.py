"""
EndpointSpecVersions model - Generated from endpoint_spec_versions table
"""
...
class EndpointSpecVersions(Base):
    __tablename__ = "endpoint_spec_versions"
    ...
    def __repr__(self):
        return f"<EndpointSpecVersions({self.id if hasattr(self, 'id') else 'no-id'})"
