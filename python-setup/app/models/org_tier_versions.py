"""
OrgTierVersions model - Generated from org_tier_versions table
"""
...
class OrgTierVersions(Base):
    __tablename__ = "org_tier_versions"
    ...
    def __repr__(self):
        return f"<OrgTierVersions({self.id if hasattr(self, 'id') else 'no-id'})"
