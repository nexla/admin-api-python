"""
GenAiOrgSettingVersions model - Generated from gen_ai_org_setting_versions table
"""
...
class GenAiOrgSettingVersions(Base):
    __tablename__ = "gen_ai_org_setting_versions"
    ...
    def __repr__(self):
        return f"<GenAiOrgSettingVersions({self.id if hasattr(self, 'id') else 'no-id'})"
