"""
CustomDataFlowVersions model - Generated from custom_data_flow_versions table
"""
...
class CustomDataFlowVersions(Base):
    __tablename__ = "custom_data_flow_versions"
    ...
    def __repr__(self):
        return f"<CustomDataFlowVersions({self.id if hasattr(self, 'id') else 'no-id'})"
