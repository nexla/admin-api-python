"""
CustomDataFlowsAccessControls model - Generated from custom_data_flows_access_controls table
"""
...
class CustomDataFlowsAccessControls(Base):
    __tablename__ = "custom_data_flows_access_controls"
    ...
    def __repr__(self):
        return f"<CustomDataFlowsAccessControls({self.id if hasattr(self, 'id') else 'no-id'})"
