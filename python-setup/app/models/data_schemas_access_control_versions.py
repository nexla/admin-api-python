"""
DataSchemasAccessControlVersions model - Generated from data_schemas_access_control_versions table
"""
...
class DataSchemasAccessControlVersions(Base):
    __tablename__ = "data_schemas_access_control_versions"
    ...
    def __repr__(self):
        return f"<DataSchemasAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
