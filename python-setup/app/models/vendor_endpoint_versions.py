"""
VendorEndpointVersions model - Generated from vendor_endpoint_versions table
"""
...
class VendorEndpointVersions(Base):
    __tablename__ = "vendor_endpoint_versions"
    ...
    def __repr__(self):
        return f"<VendorEndpointVersions({self.id if hasattr(self, 'id') else 'no-id'})"
