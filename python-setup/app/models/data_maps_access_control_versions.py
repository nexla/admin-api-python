"""
DataMapsAccessControlVersions model - Generated from data_maps_access_control_versions table
"""
...
class DataMapsAccessControlVersions(Base):
    __tablename__ = "data_maps_access_control_versions"
    ...
    def __repr__(self):
        return f"<DataMapsAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
