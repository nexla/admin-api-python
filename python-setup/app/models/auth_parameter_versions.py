"""
AuthParameterVersions model - Generated from auth_parameter_versions table
"""
...
class AuthParameterVersions(Base):
    __tablename__ = "auth_parameter_versions"
    ...
    def __repr__(self):
        return f"<AuthParameterVersions({self.id if hasattr(self, 'id') else 'no-id'})"
