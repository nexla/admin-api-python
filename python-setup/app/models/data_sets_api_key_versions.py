"""
DataSetsApiKeyVersions model - Generated from data_sets_api_key_versions table
"""
...
class DataSetsApiKeyVersions(Base):
    __tablename__ = "data_sets_api_key_versions"
    ...
    def __repr__(self):
        return f"<DataSetsApiKeyVersions({self.id if hasattr(self, 'id') else 'no-id'})"
