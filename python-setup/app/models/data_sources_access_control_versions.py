"""
DataSourcesAccessControlVersions model - Generated from data_sources_access_control_versions table
"""
...
class DataSourcesAccessControlVersions(Base):
    __tablename__ = "data_sources_access_control_versions"
    ...
    def __repr__(self):
        return f"<DataSourcesAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
