"""
SelfSignupRequestVersions model - Generated from self_signup_request_versions table
"""
...
class SelfSignupRequestVersions(Base):
    __tablename__ = "self_signup_request_versions"
    ...
    def __repr__(self):
        return f"<SelfSignupRequestVersions({self.id if hasattr(self, 'id') else 'no-id'})"
