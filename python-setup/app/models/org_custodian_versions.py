"""
OrgCustodianVersions model - Generated from org_custodian_versions table
"""
...
class OrgCustodianVersions(Base):
    __tablename__ = "org_custodian_versions"
    ...
    def __repr__(self):
        return f"<OrgCustodianVersions({self.id if hasattr(self, 'id') else 'no-id'})"
