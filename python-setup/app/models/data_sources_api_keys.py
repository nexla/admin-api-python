"""
DataSourcesApiKeys model - Generated from data_sources_api_keys table
"""
...
class DataSourcesApiKeys(Base):
    __tablename__ = "data_sources_api_keys"
    ...
    def __repr__(self):
        return f"<DataSourcesApiKeys({self.id if hasattr(self, 'id') else 'no-id'})"
