"""
DataFlowsAccessControlVersions model - Generated from data_flows_access_control_versions table
"""
...
class DataFlowsAccessControlVersions(Base):
    __tablename__ = "data_flows_access_control_versions"
    ...
    def __repr__(self):
        return f"<DataFlowsAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
