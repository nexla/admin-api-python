"""
DashboardTransforms model - Generated from dashboard_transforms table
"""
...
class DashboardTransforms(Base):
    __tablename__ = "dashboard_transforms"
    ...
    def __repr__(self):
        return f"<DashboardTransforms({self.id if hasattr(self, 'id') else 'no-id'})"
