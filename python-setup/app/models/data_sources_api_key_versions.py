"""
DataSourcesApiKeyVersions model - Generated from data_sources_api_key_versions table
"""
...
class DataSourcesApiKeyVersions(Base):
    __tablename__ = "data_sources_api_key_versions"
    ...
    def __repr__(self):
        return f"<DataSourcesApiKeyVersions({self.id if hasattr(self, 'id') else 'no-id'})"
