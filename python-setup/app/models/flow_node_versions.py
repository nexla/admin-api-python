"""
FlowNodeVersions model - Generated from flow_node_versions table
"""
...
class FlowNodeVersions(Base):
    __tablename__ = "flow_node_versions"
    ...
    def __repr__(self):
        return f"<FlowNodeVersions({self.id if hasattr(self, 'id') else 'no-id'})"
