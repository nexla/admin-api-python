"""
ResourceParameterVersions model - Generated from resource_parameter_versions table
"""
...
class ResourceParameterVersions(Base):
    __tablename__ = "resource_parameter_versions"
    ...
    def __repr__(self):
        return f"<ResourceParameterVersions({self.id if hasattr(self, 'id') else 'no-id'})"
