"""
DocContainersAccessControls model - Generated from doc_containers_access_controls table
"""
...
class DocContainersAccessControls(Base):
    __tablename__ = "doc_containers_access_controls"
    ...
    def __repr__(self):
        return f"<DocContainersAccessControls({self.id if hasattr(self, 'id') else 'no-id'})"
