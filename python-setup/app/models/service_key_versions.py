"""
ServiceKeyVersions model - Generated from service_key_versions table
"""
...
class ServiceKeyVersions(Base):
    __tablename__ = "service_key_versions"
    ...
    def __repr__(self):
        return f"<ServiceKeyVersions({self.id if hasattr(self, 'id') else 'no-id'})"
