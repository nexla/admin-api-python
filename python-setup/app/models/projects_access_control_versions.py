"""
ProjectsAccessControlVersions model - Generated from projects_access_control_versions table
"""
...
class ProjectsAccessControlVersions(Base):
    __tablename__ = "projects_access_control_versions"
    ...
    def __repr__(self):
        return f"<ProjectsAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
