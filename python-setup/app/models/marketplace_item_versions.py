"""
MarketplaceItemVersions model - Generated from marketplace_item_versions table
"""
...
class MarketplaceItemVersions(Base):
    ...
    def __repr__(self):
        return f"<MarketplaceItemVersions({self.id if hasattr(self, 'id') else 'no-id'})"
