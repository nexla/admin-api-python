"""
AuthTemplateVersions model - Generated from auth_template_versions table
"""
...
class AuthTemplateVersions(Base):
    __tablename__ = "auth_template_versions"
    ...
    def __repr__(self):
        return f"<AuthTemplateVersions({self.id if hasattr(self, 'id') else 'no-id'})"
