"""
DataSetVersions model - Generated from data_set_versions table
"""
...
class DataSetVersions(Base):
    __tablename__ = "data_set_versions"
    ...
    def __repr__(self):
        return f"<DataSetVersions({self.id if hasattr(self, 'id') else 'no-id'})"
