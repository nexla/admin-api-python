"""
DataCredentialsAccessControlVersions model - Generated from data_credentials_access_control_versions table
"""
...
class DataCredentialsAccessControlVersions(Base):
    __tablename__ = "data_credentials_access_control_versions"
    ...
    def __repr__(self):
        return f"<DataCredentialsAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
