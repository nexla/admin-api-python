"""
FlowNodesAccessControlVersions model - Generated from flow_nodes_access_control_versions table
"""
...
class FlowNodesAccessControlVersions(Base):
    __tablename__ = "flow_nodes_access_control_versions"
    ...
    def __repr__(self):
        return f"<FlowNodesAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
