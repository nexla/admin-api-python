"""
FlowLinkVersions model - Generated from flow_link_versions table
"""
...
class FlowLinkVersions(Base):
    __tablename__ = "flow_link_versions"
    ...
    def __repr__(self):
        return f"<FlowLinkVersions({self.id if hasattr(self, 'id') else 'no-id'})"
