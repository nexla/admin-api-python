"""
OrgsAccessControls model - Generated from orgs_access_controls table
"""
...
class OrgsAccessControls(Base):
    __tablename__ = "orgs_access_controls"
    ...
    def __repr__(self):
        return f"<OrgsAccessControls({self.id if hasattr(self, 'id') else 'no-id'})"
