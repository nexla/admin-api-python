"""
CatalogConfigVersions model - Generated from catalog_config_versions table
"""
...
class CatalogConfigVersions(Base):
    __tablename__ = "catalog_config_versions"
    ...
    def __repr__(self):
        return f"<CatalogConfigVersions({self.id if hasattr(self, 'id') else 'no-id'})"
