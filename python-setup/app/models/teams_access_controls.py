"""
TeamsAccessControls model - Generated from teams_access_controls table
"""
...
class TeamsAccessControls(Base):
    __tablename__ = "teams_access_controls"
    ...
    def __repr__(self):
        return f"<TeamsAccessControls({self.id if hasattr(self, 'id') else 'no-id'})"
