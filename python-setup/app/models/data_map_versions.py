"""
DataMapVersions model - Generated from data_map_versions table
"""
...
class DataMapVersions(Base):
    __tablename__ = "data_map_versions"
    ...
    def __repr__(self):
        return f"<DataMapVersions({self.id if hasattr(self, 'id') else 'no-id'})"
