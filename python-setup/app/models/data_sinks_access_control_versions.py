"""
DataSinksAccessControlVersions model - Generated from data_sinks_access_control_versions table
"""
...
class DataSinksAccessControlVersions(Base):
    __tablename__ = "data_sinks_access_control_versions"
    ...
    def __repr__(self):
        return f"<DataSinksAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
