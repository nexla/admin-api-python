"""
DataSourceVersions model - Generated from data_source_versions table
"""
...
class DataSourceVersions(Base):
    ...
    def __repr__(self):
        return f"<DataSourceVersions({self.id if hasattr(self, 'id') else 'no-id'})"
