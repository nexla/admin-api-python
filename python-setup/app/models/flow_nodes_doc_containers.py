"""
FlowNodesDocContainers model - Generated from flow_nodes_doc_containers table
"""
...
class FlowNodesDocContainers(Base):
    __tablename__ = "flow_nodes_doc_containers"
    ...
    def __repr__(self):
        return f"<FlowNodesDocContainers({self.id if hasattr(self, 'id') else 'no-id'})"
