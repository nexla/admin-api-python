"""
DataSchemaVersions model - Generated from data_schema_versions table
"""
...
class DataSchemaVersions(Base):
    ...
    def __repr__(self):
        return f"<DataSchemaVersions({self.id if hasattr(self, 'id') else 'no-id'})"
