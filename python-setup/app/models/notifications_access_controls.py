"""
NotificationsAccessControls model - Generated from notifications_access_controls table
"""
...
class NotificationsAccessControls(Base):
    __tablename__ = "notifications_access_controls"
    ...
    def __repr__(self):
        return f"<NotificationsAccessControls({self.id if hasattr(self, 'id') else 'no-id'})"
