"""
CodeFilterVersions model - Generated from code_filter_versions table
"""
...
class CodeFilterVersions(Base):
    __tablename__ = "code_filter_versions"
    ...
    def __repr__(self):
        return f"<CodeFilterVersions({self.id if hasattr(self, 'id') else 'no-id'})"
