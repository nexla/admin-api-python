"""
DataSetsCatalogRefVersions model - Generated from data_sets_catalog_ref_versions table
"""
...
class DataSetsCatalogRefVersions(Base):
    __tablename__ = "data_sets_catalog_ref_versions"
    ...
    def __repr__(self):
        return f"<DataSetsCatalogRefVersions({self.id if hasattr(self, 'id') else 'no-id'})"
