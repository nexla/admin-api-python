"""
NotificationsAccessControlVersions model - Generated from notifications_access_control_versions table
"""
...
class NotificationsAccessControlVersions(Base):
    __tablename__ = "notifications_access_control_versions"
    ...
    def __repr__(self):
        return f"<NotificationsAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
