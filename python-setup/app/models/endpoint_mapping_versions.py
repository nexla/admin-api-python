"""
EndpointMappingVersions model - Generated from endpoint_mapping_versions table
"""
...
class EndpointMappingVersions(Base):
    __tablename__ = "endpoint_mapping_versions"
    
    id = Column(Integer, nullable=False)
    item_type = Column(String(255), index=True)
    {:null=>false, :limit=>191} = Column(String(255))
    ...
    def __repr__(self):
        return f"<EndpointMappingVersions({self.id if hasattr(self, 'id') else 'no-id'})"
