"""
ClusterEndpointVersions model - Generated from cluster_endpoint_versions table
"""
...
class ClusterEndpointVersions(Base):
    __tablename__ = "cluster_endpoint_versions"
    ...
    def __repr__(self):
        return f"<ClusterEndpointVersions({self.id if hasattr(self, 'id') else 'no-id'})"
