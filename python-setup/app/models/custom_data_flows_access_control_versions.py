"""
CustomDataFlowsAccessControlVersions model - Generated from custom_data_flows_access_control_versions table
"""
...
class CustomDataFlowsAccessControlVersions(Base):
    __tablename__ = "custom_data_flows_access_control_versions"
    ...
    def __repr__(self):
        return f"<CustomDataFlowsAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
