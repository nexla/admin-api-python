"""
UsersApiKeyVersions model - Generated from users_api_key_versions table
"""
...
class UsersApiKeyVersions(Base):
    __tablename__ = "users_api_key_versions"
    ...
    def __repr__(self):
        return f"<UsersApiKeyVersions({self.id if hasattr(self, 'id') else 'no-id'})"
