"""
DocContainersAccessControlVersions model - Generated from doc_containers_access_control_versions table
"""
...
class DocContainersAccessControlVersions(Base):
    __tablename__ = "doc_containers_access_control_versions"
    ...
    def __repr__(self):
        return f"<DocContainersAccessControlVersions({self.id if hasattr(self, 'id') else 'no-id'})"
