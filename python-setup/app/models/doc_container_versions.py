"""
DocContainerVersions model - Generated from doc_container_versions table
"""
...
class DocContainerVersions(Base):
    __tablename__ = "doc_container_versions"
    ...
    def __repr__(self):
        return f"<DocContainerVersions({self.id if hasattr(self, 'id') else 'no-id'})"
