"""
UserTierVersions model - Generated from user_tier_versions table
"""
...
class UserTierVersions(Base):
    __tablename__ = "user_tier_versions"
    ...
    def __repr__(self):
        return f"<UserTierVersions({self.id if hasattr(self, 'id') else 'no-id'})"
