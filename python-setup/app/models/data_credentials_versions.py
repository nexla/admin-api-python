"""
DataCredentialsVersions model - Generated from data_credentials_versions table
"""
...
class DataCredentialsVersions(Base):
    __tablename__ = "data_credentials_versions"
    ...
    def __repr__(self):
        return f"<DataCredentialsVersions({self.id if hasattr(self, 'id') else 'no-id'})"
