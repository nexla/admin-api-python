"""
DataSinksApiKeyVersions model - Generated from data_sinks_api_key_versions table
"""
...
class DataSinksApiKeyVersions(Base):
    __tablename__ = "data_sinks_api_key_versions"
    ...
    def __repr__(self):
        return f"<DataSinksApiKeyVersions({self.id if hasattr(self, 'id') else 'no-id'})"
