"""
DomainMarketplaceItemVersions model - Generated from domain_marketplace_item_versions table
"""
...
class DomainMarketplaceItemVersions(Base):
    __tablename__ = "domain_marketplace_item_versions"
    ...
    def __repr__(self):
        return f"<DomainMarketplaceItemVersions({self.id if hasattr(self, 'id') else 'no-id'})"
