"""
GenAiConfigVersions model - Generated from gen_ai_config_versions table
"""
...
class GenAiConfigVersions(Base):
    __tablename__ = "gen_ai_config_versions"
    ...
    def __repr__(self):
        return f"<GenAiConfigVersions({self.id if hasattr(self, 'id') else 'no-id'})"
